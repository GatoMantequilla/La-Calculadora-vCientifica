        ...
        try {
            switch (figura.toLowerCase()) {
                case "cuadrado":
                    ...
                    return String.format("Cuadrado - Perímetro: %.2f, Área: %.2f", perimetroCuadrado, areaCuadrado);
                ...
                case "rectángulo":
                    ...
                    return String.format("Rectángulo - Perímetro: %.2f, Área: %.2f", perimetroRectangulo, areaRectangulo);

                case "círculo":
                    double radio = dimensiones[0];
                    double perimetroCirculo = 2 * Math.PI * radio;
                    double areaCirculo = Math.PI * Math.pow(radio, 2);
                    return String.format("Círculo - Perímetro: %.2f, Área: %.2f", perimetroCirculo, areaCirculo);
                ...
                case "esfera":
                    ...
                    return String.format("Esfera - Área: %.2f, Volumen: %.2f", areaEsfera, volumenEsfera);

                case "cubo":
                    double ladoCubo = dimensiones[0];
                    double areaCubo = 6 * Math.pow(ladoCubo, 2);
                    double volumenCubo = Math.pow(ladoCubo, 3);
                    return String.format("Cubo - Área: %.2f, Volumen: %.2f", areaCubo, volumenCubo);
                ...
                case "cono":
                    ...
                    double volumenCono = (1.0 / 3.0) * Math.PI * Math.pow(radioCono, 3) * alturaCono;
                    return String.format("Cono - Área: %.2f, Volumen: %.2f", areaCono, volumenCono);
